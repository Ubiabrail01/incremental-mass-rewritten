        ...
        photon: [
            {
                ...
                effect(x) { return player.stars.points.add(1).log10().add(1).pow(x.mul(0.2))},
                ...
                effect(i) {
                    let x = player.supernova.bosons.photon.add(1).log10().add(1).pow(i.pow(tmp.fermions.effs[0][3]).mul(0.5))
